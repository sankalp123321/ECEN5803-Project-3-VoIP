...
if /i not "%1"=="pass1" goto :Not_Pass1
    ...
    if not "%SYSGEN_USDK%"=="1" goto NoUSDK
        ...
        set SYSGEN_DOTNETV35_SUPPORT=1
    :NoUSDK

    REM ==============================================================================================
    REM
    REM SDK for Smart Devices features
    REM Emulates SYSGEN_USDK going forward
    REM ==============================================================================================
    if not "%SYSGEN_SMARTDEVICES_SDK%"=="1" goto NoSmartDeviceSDK
        set SYSGEN_AYGSHELL=1
        set SYSGEN_AUDIO=1
        set SYSGEN_IE7_WININET=1
        set SYSGEN_IE7_URLMON=1
