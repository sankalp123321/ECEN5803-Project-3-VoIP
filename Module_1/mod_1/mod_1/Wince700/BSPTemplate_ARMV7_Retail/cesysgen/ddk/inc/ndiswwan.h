...
typedef enum _WWAN_RESULT_CODE
{
    ...
    WwanResultInvalidContextState,   /* Failed, invalid context activation state */
    WwanResultServiceUnavailable,   /* Failed, e.g. no packet roaming      */
    WwanResultServerNotResponding,  /* Failed, ex. bad APN                 */
    WwanResultRemoteDisconnection,  /* Failed, a remote disconnect occurred */
...
typedef struct _WWAN_ASYNC_NOTIFY
{
    ...
    WWAN_RESULT_CODE       Indication;   /* Can be used to convey a failure cause 
                                            as in the case of NDIS_WW_ACTIVATION_STATE*/
}
WWAN_ASYNC_NOTIFY;
...
#define    WWAN_CONTEXT_OPTIONS_SPECIFICIPDDR          0x01
#define    WWAN_CONTEXT_OPTIONS_SPECIFICNAMESERVERS    0x02
#define    WWAN_CONTEXT_OPTIONS_IPHEADERCOMPRESSION    0x04
#define    WWAN_CONTEXT_OPTIONS_SWCOMPRESSION          0x08
#define    WWAN_CONTEXT_OPTIONS_ALL                    0x0f

#define    WWAN_CONTEXT_PROTOCOLS_IPV4                 0x01
#define    WWAN_CONTEXT_PROTOCOLS_IPV6                 0x02
#define    WWAN_CONTEXT_PROTOCOLS_ALL                  0x03

typedef struct _WWAN_CONTEXT
{
    ULONG   ContextID;                     /* Identifier for use by application. 
                                                It is reflected in the same structure
                                                sent with NDIS_WW_ACTIVATION_STATE
                                                notification.       */
...
typedef struct _WWAN_CONTEXT_EX
{
    ULONG  Size;                         /* size of this structure */
    WWAN_CONTEXT WwanContext;
    ULONG  Options;       
    ULONG  IpV4Addr;                     /* IP address for this interface instance*/
    ULONG  IpV4AddrDns;                  /* Primary DNS for this connection*/
    ULONG  IpV4AddrDnsAlt;               /* Secondary DNS for this connection*/
    ULONG  NetProtocols;  
}
WWAN_CONTEXT_EX;
...
#define NDIS_WW_WWAN_CONTEXT                0x00001008
...
#define OID_WW_SET_ACTIVATION_STATE_EX       0x0e010116
