...
#define OID_DOT11_ADAPTIVE_CTRL_SETTINGS            NWF_DEFINE_OID(159,NWF_OPERATIONAL_OID,NWF_MANDATORY_OID)
    typedef enum _DOT11_ADAPTIVE_RESUME_STATE_START
    {
        STA_FSM_NOT_SET = 0,
        STA_FSM_DISCONNECTED,
        STA_FSM_CONNECTED,
        STA_FSM_ROAMING,
        STA_FSM_QUICK_CONNECT
    } DOT11_ADAPTIVE_RESUME_STATE_START;
    typedef struct _DOT11_PUBLIC_REGISTRY_ADAPTIVE_CTRL
    {
        BOOL                                bResetOnSuspendResume;
        BOOL                                bPwrCtrlOnSuspendResume;
        DOT11_ADAPTIVE_RESUME_STATE_START   dwAdaptiveResumeStateStart;
        //Other public registry controls go here
    } DOT11_PUBLIC_REGISTRY_ADAPTIVE_CTRL, *PDOT11_PUBLIC_REGISTRY_ADAPTIVE_CTRL;
    typedef struct _DOT11_PUBLIC_NON_REGISTRY_ADAPTIVE_CTRL
    {   
        BOOL bAdapterRemoved;
        //other public non registry controls go here
    } DOT11_PUBLIC_NON_REGISTRY_ADAPTIVE_CTRL, *PDOT11_PUBLIC_NON_REGISTRY_ADAPTIVE_CTRL;
    typedef struct _DOT11_PUBLIC_ADAPTIVE_CTRL
    {
        DOT11_PUBLIC_REGISTRY_ADAPTIVE_CTRL currentRegistryAdaptiveControl;
        DOT11_PUBLIC_NON_REGISTRY_ADAPTIVE_CTRL nonRegistryAdaptiveControl;
    } DOT11_PUBLIC_ADAPTIVE_CTRL, *PDOT11_PUBLIC_ADAPTIVE_CTRL;
//
...
typedef struct DOT11_FSM_QUICK_CONNECT_PARAMETERS {
    #define DOT11_FSM_QUICK_CONNECT_PARAMETERS_1  1
    NDIS_OBJECT_HEADER Header;
    //TODO Stuart - Verify if we need other parameters
} DOT11_FSM_QUICK_CONNECT_PARAMETERS, * PDOT11_FSM_QUICK_CONNECT_PARAMETERS;
...
DEFINE_NWF_GUID(GUID_NWF_ADAPT_CTRL_REG_SETTINGS,159);
