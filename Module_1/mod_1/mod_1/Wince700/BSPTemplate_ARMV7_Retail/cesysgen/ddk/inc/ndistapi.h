...
#ifdef UNDER_CE
#define NDIS_TAPI_CURRENT_VERSION 0x00030000    // CE TAPI has some 3.0 functionality
#else  //  UNDER_CE
...
#ifdef UNDER_CE
#ifdef LAST_LINEMEDIAMODE
// TAPI has advanced - need to undefine to support backward compatibility
...
#undef LAST_LINEMEDIAMODE
#ifdef UNDER_CE
#define LAST_LINEMEDIAMODE                      0x00020000      // Should override last definition.
#else  //  UNDER_CE
...
// #if (NDIS_TAPI_CURRENT_VERSION >= 0x00020000)  //  #ifndef UNDER_CE
...
// #if (NDIS_TAPI_CURRENT_VERSION >= 0x00030000)  //  #ifndef UNDER_CE
...
#ifdef UNDER_CE
typedef struct _NDIS_LINE_TRANSLATE_OUTPUT
{
    ULONG       ulTotalSize;
    ULONG       ulNeededSize;
    ULONG       ulUsedSize;
    ULONG       ulDialableStringSize;
    ULONG       ulDialableStringOffset;
    ULONG       ulDisplayableStringSize;
    ULONG       ulDisplayableStringOffset;
    ULONG       ulCurrentCountry;
    ULONG       ulDestCountry;
    ULONG       ulTranslateResults;

} LINE_TRANSLATE_OUTPUT, *PLINE_TRANSLATE_OUTPUT;

typedef struct _NDIS_TAPI_LINE_TRANSLATE
{
    IN  ULONG       ulRequestID;
    IN  ULONG       ulDeviceID;
    IN  ULONG       ulAddressInLen;     // Len of AddressIn, Address in DataBuf
    IN  ULONG       ulCard;
    IN  ULONG       ulTranslateOptions;
    IN  ULONG       ulLineTranslateOutputOffset;
    OUT UCHAR       DataBuf[1];         // AddressIn followed by LINE_TRANSLATE_OUTPUT
                                    
} NDIS_TAPI_LINE_TRANSLATE, *PNDIS_TAPI_LINE_TRANSLATE;

typedef struct _NDIS_TAPI_LINE_CONFIG_DIALOG_EDIT
{
    IN  ULONG       ulRequestID;
    IN  ULONG       ulDeviceID;
    IN  HWND        hwndOwner;
    IN  ULONG       ulDeviceClassLen;
    IN  ULONG       ulConfigInOffset;
    IN  ULONG       ulConfigInSize;         // Size of DeviceConfigIn
    IN  ULONG       ulConfigOutOffset;      // Offset in DevConfig for DeviceConfigOut
    OUT UCHAR       DataBuf[1];             // DeviceClass string followed by
                                            // DeviceConfigIn followed by VARSTRING with
                                            // DeviceConfigOut
} NDIS_TAPI_LINE_CONFIG_DIALOG_EDIT, *PNDIS_TAPI_LINE_CONFIG_DIALOG_EDIT;
#endif  //  UNDER_CE
