...
// #if (defined(NDIS_MINIPORT_DRIVER))  //  #ifdef UNDER_CE
//
...
#error ("Define NDIS_MINIPORT_DRIVER for NDIS 6.1 miniport drivers.")
#endif
#endif  //  UNDER_CE
...
#ifdef UNDER_CE
#ifndef NDIS_MINIPORT_DRIVER
#error ("Define NDIS_MINIPORT_DRIVER for NDIS 6.0 miniport drivers.")
#endif
#endif  //  UNDER_CE
...
#endif
#define NDIS_MINIPORT_MAJOR_VERSION 4
#define NDIS_MINIPORT_MINOR_VERSION 0
#ifndef NDIS_MINIPORT_DRIVER
#define NDIS_MINIPORT_DRIVER
#endif
...
// #endif // NDIS_MINIPORT_DRIVER  //  #endif  //  UNDER_CE
...
// #if (!defined(NDIS_MINIPORT_DRIVER) && !defined (NDIS_PROTOCOL_MAJOR_VERSION))  //  #ifdef UNDER_CE
#ifdef UNDER_CE
#ifndef NDIS_PROTOCOL_MAJOR_VERSION
#define NDIS40
#define NDIS_PROTOCOL_MAJOR_VERSION 4
#define NDIS_PROTOCOL_MINOR_VERSION 0
#endif
...
#define NDIS_PROTOCOL_MINOR_VERSION 0
#endif  //  UNDER_CE
// #endif // (!defined(NDIS_MINIPORT_DRIVER) && !defined (NDIS_PROTOCOL_MAJOR_VERSION))  //  UNDER_CE
...
#ifdef UNDER_CE
#ifndef RtlRetrieveUshort
#define RtlRetrieveUshort(Destination, Source)   (*(Destination)) = *(UNALIGNED USHORT *)(Source)
#endif
#ifndef RtlStoreUshort
#define RtlStoreUshort(Destination, Value)   *(UNALIGNED USHORT *)(Destination) = (Value)
#endif
#endif  //  UNDER_CE

#define NdisRetrieveUshort(Destination, Source)      RtlRetrieveUshort(Destination, Source)
#define NdisStoreUshort(Destination, Value)          RtlStoreUshort(Destination, Value)
...
#if NDIS_LEGACY_DRIVER
#ifdef UNDER_CE
#define Ieee8021QInfo   Ieee8021pPriority
#else  //  UNDER_CE
//
...
// #if (defined(NDIS50) || defined(NDIS51) || defined(NDIS50_MINIPORT) || defined(NDIS51_MINIPORT))  //  #ifndef UNDER_CE
...
//
#ifdef UNDER_CE
#define NDIS_STATUS_OFFLOAD_PAUSE               ((NDIS_STATUS)0x4002000DL)
#else  //  UNDER_CE
...
#define NDIS_STATUS_DOT11_FSM_QUICK_CONNECT_START         ((NDIS_STATUS)0x4003000DL)
#endif // NDIS_SUPPORT_NDIS6
...
// #if defined(_M_IX86) || defined(_M_AMD64)  //  #ifndef UNDER_CE
// #endif
#if defined(_M_IX86)
...
#ifndef UNDER_CE  //  WIN32IOERRLOG
#define NDIS_MAX_EVENT_LOG_DATA_SIZE ((ERROR_LOG_MAXIMUM_SIZE - sizeof(IO_ERROR_LOG_PACKET) + sizeof(ULONG)) & ~3)
#endif  //  UNDER_CE

#ifdef UNDER_CE  //  MULTIPROC
#ifdef NDIS_MAX_PROCESSOR_COUNT
#undef NDIS_MAX_PROCESSOR_COUNT
#endif
#define NDIS_MAX_PROCESSOR_COUNT   1
#else  //  UNDER_CE
#ifdef _WIN64
...
#ifdef UNDER_CE
#define NDIS_FREE_MUTEX(_M_)                KeUninitializeMutex(_M_)
#endif  //  UNDER_CE
...
NdisAllocateMemoryWithTagPriority(
    ...
    IN  EX_POOL_PRIORITY        Priority  OPTIONAL
#else  //  UNDER_CE
    IN  ULONG                   Tag,
...
// #if  (NTDDI_VERSION >= NTDDI_VISTA)  //  #ifndef UNDER_CE
...
#ifdef UNDER_CE
//  pmimpl.h and guiddef.h
#if !( defined(_LPCGUID_DEFINED) || defined(__LPCGUID_DEFINED__) )
...
// #if (NDIS_SUPPORT_NDIS6 || NDIS60)  //  #ifndef UNDER_CE
...
#if (NDIS_SUPPORT_NDIS6 || NDIS60)  //  #ifdef UNDER_CE
...
NdisGetAdapterNames(
    OUT PNDIS_STATUS    pStatus,
    __in_bcount(cbOutBufSize) OUT   PBYTE           pOutBuf,
...
NdisGetAdapterBindings(
    ...
    __out_bcount(cbOutBufSize) OUT  PBYTE           pOutBuf,
    IN  DWORD           cbOutBufSize,
    OUT PDWORD          pcbReturned);
...
NdisGetLogData(
    ...
    __out_bcount(nOutBufSize) PBYTE pOutBuf,
    DWORD   nOutBufSize,
...
// #if (((NDIS_MINIPORT_MAJOR_VERSION == 5) &&  (NDIS_MINIPORT_MINOR_VERSION == 1)) || NDIS_WRAPPER)  //  #ifndef UNDER_CE
//
...
// #endif // (((NDIS_MINIPORT_MAJOR_VERSION == 5) &&  (NDIS_MINIPORT_MINOR_VERSION == 1)) || NDIS_WRAPPER)  //  #endif  //  UNDER_CE
...
//    PNDIS_BIND_PATHS            BindPaths;
    ...
    UCHAR                       ReservedCe1;           // DO NOT REMOVE OR NDIS WILL BREAK!!!
    ULONG                           ReservedCe2;
#else  //  UNDER_CE
    NDIS_OBJECT_HEADER          Header;
    PNDIS_MINIPORT_BLOCK        NextMiniport;       // used by driver's MiniportQueue
...
NdisMQueryAdapterResources(
    ...
    IN  NDIS_HANDLE             WrapperConfigurationContext,
#ifdef UNDER_CE
    __out_bcount_opt(*BufferSize) OUT PNDIS_RESOURCE_LIST     ResourceList,
#else  //  UNDER_CE
...
#define NDIS_ATTRIBUTE_ALWAYS_GIVES_RX_PACKET_OWNERSHIP 0x00000800
#else  //  UNDER_CE
...
NOTE: NdisMFddiIndicateReceive() is deprecated.
...
NOTE: NdisMArcIndicateReceive() is deprecated.
...
NOTE: NdisMFddiIndicateReceiveComplete() is deprecated.
...
NOTE: NdisMArcIndicateReceiveComplete() is deprecated.
...
NdisMWriteLogData(
    IN  NDIS_HANDLE             LogHandle,
#ifdef UNDER_CE
    __in_bcount(LogBufferSize) IN  PVOID                   LogBuffer,
#else  //  UNDER_CE
    IN  PVOID                   LogBuffer,
#endif  //  UNDER_CE
