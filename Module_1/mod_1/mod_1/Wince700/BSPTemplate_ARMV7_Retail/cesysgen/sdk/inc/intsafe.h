    ...
    __out ULONG* pulResult)
{
    ...
    *pulResult = ULONG_ERROR;
    ...
    ulPadAmount = (ulMultiple - (ulAugend % ulMultiple)) % ulMultiple;

    hr = ULongAdd(ulAugend, ulPadAmount, pulResult);
...
UShortMult(
    ...
    __out __deref_out_range(==, ulMultiplier * ulMultiplicand) USHORT* pusResult)
{
...
UIntMult(
    ...
    __out __deref_out_range(==, ulMultiplier * ulMultiplicand) UINT* puResult)
{
