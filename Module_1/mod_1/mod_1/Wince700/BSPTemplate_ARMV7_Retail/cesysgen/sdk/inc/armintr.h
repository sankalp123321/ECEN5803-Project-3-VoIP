...
// armintr.h includes all the ARM specific intrinsic definitions
//
#include "arm_neon.h"
...
_ARMINTR_SHIFT_T;
             ...
             int __arm_gen_s_Rd_RnRmRs  (const unsigned int, int, int, int);
...
unsigned     int __arm_gen_u_Rd_RnRmRs  (const unsigned int, unsigned int, unsigned int, unsigned int);
