...
#ifdef UNDER_CE
// Note: CE doesn’t support renaming cache extension. We need to reserve 95, 96, and 97 for WM6.1.
...
#ifdef UNDER_CE
#define ERROR_INTERNET_NO_CM_CONNECTION         (INTERNET_ERROR_BASE + 200)
#define INTERNET_ERROR_LAST                     ERROR_INTERNET_NO_CM_CONNECTION
#else
...
#ifndef UNDER_CE // Cache Group not supported
