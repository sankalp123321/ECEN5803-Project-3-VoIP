...
//
// OLEDBVER
//	OLE DB version number (0x0210); this can be overridden with an older
// version number if necessary
//

// If OLEDBVER is not defined, assume version 2.1
#ifndef OLEDBVER
...
// MessageText:
//
//  The rguidColumnType pointed to a GUID that does not 
...
// MessageText:
//
//  The OLE DB object represented by this URL is locked by one 
...
// MessageText:
//
//  The client requested an object type that is only valid for 
//  a collection 
//
...
// MessageText:
//
//  The provider was unable to create an object at this URL 
//  because an object named by this URL already exists
//
...
// MessageText:
//
//  The provider was unable to create an object at this URL because 
//  the server was out of physical storage
//
...
// MessageText:
//
//  the bind failed because the provider was unable to satisfy all of
//  the bind flags or properties
//
