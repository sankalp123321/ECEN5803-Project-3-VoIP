...
#ifdef UNDER_CE
// Warning 4995 is suppressed here for the declaration of the deprecated Str* and *printf* APIs
// Programs that call the deprecated APIs will still get the warning
#pragma warning(push)
