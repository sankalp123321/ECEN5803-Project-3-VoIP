...
#ifndef __IUPnPDeviceControlEx_FWD_DEFINED__
#define __IUPnPDeviceControlEx_FWD_DEFINED__
typedef interface IUPnPDeviceControlEx IUPnPDeviceControlEx;
#endif 	/* __IUPnPDeviceControlEx_FWD_DEFINED__ */
...
#ifndef __IUPnPDeviceControlEx_INTERFACE_DEFINED__
#define __IUPnPDeviceControlEx_INTERFACE_DEFINED__

/* interface IUPnPDeviceControlEx */
/* [object][unique][uuid] */ 


EXTERN_C const IID IID_IUPnPDeviceControlEx;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("204810bb-73b2-11d4-bf42-00b0d0118b56")
    IUPnPDeviceControlEx : public IUPnPDeviceControl
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE GenerateUDN( 
            /* [in] */ BSTR bstrInitString,
            /* [retval][out] */ GUID *pguidUDN) = 0;
        
    };
    
#else 	/* C style interface */

    typedef struct IUPnPDeviceControlExVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IUPnPDeviceControlEx * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *GenerateUDN )( 
            IUPnPDeviceControlEx * This,
            /* [in] */ BSTR bstrInitString,
            /* [retval][out] */ GUID *pguidUDN);
        
        END_INTERFACE
    } IUPnPDeviceControlExVtbl;

    interface IUPnPDeviceControlEx
    {
        CONST_VTBL struct IUPnPDeviceControlExVtbl *lpVtbl;
    };
...
#define IUPnPDeviceControlEx_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IUPnPDeviceControlEx_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IUPnPDeviceControlEx_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IUPnPDeviceControlEx_Initialize(This,bstrXMLDesc,bstrDeviceIdentifier,bstrInitString)	\
    ( (This)->lpVtbl -> Initialize(This,bstrXMLDesc,bstrDeviceIdentifier,bstrInitString) ) 

#define IUPnPDeviceControlEx_GetServiceObject(This,bstrUDN,bstrServiceId,ppdispService)	\
    ( (This)->lpVtbl -> GetServiceObject(This,bstrUDN,bstrServiceId,ppdispService) ) 


#define IUPnPDeviceControlEx_GenerateUDN(This,bstrInitString,pguidUDN)	\
    ( (This)->lpVtbl -> GenerateUDN(This,bstrInitString,pguidUDN) ) 
...
#endif 	/* __IUPnPDeviceControlEx_INTERFACE_DEFINED__ */
