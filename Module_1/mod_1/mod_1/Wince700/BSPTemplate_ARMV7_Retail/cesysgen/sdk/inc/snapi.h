...
////////////////////////////////////////////////////////////////////////////////
// ConnectionsDtptState
// Gets a value indicating connectivity state of DTPT
#define SN_CONNECTIONSDTPTSTATE_ROOT HKEY_LOCAL_MACHINE
#define SN_CONNECTIONSDTPTSTATE_PATH TEXT("System\\State\\Connections\\DTPT")
#define SN_CONNECTIONSDTPTSTATE_VALUE TEXT("State")
#define SN_CONNECTIONSDTPTSTATE_USBCABLECONNECTED_BITMASK    (DWORD)0x00000001
#define SN_CONNECTIONSDTPTSTATE_RASDISCONNECTED_BITMASK      ~SN_CONNECTIONSDTPTSTATE_USBCABLECONNECTED_BITMASK
#define SN_CONNECTIONSDTPTSTATE_RASCONNECTED_BITMASK         (DWORD)0x00000002
#define SN_CONNECTIONSDTPTSTATE_RASJUSTCONNECTED_BITMASK     ( SN_CONNECTIONSDTPTSTATE_USBCABLECONNECTED_BITMASK | \
                                                               SN_CONNECTIONSDTPTSTATE_RASCONNECTED_BITMASK )
#define SN_CONNECTIONSDTPTSTATE_UDP2TCPCONNECTED_BITMASK     (DWORD)0x00000004
#define SN_CONNECTIONSDTPTSTATE_PROXIESBEGUN_BITMASK         (DWORD)0x80000000
#define SN_CONNECTIONSDTPTSTATE_PROXIESPOPULATED_BITMASK     (DWORD)0x00000008
#if 0
#define SN_CONNECTIONSDTPTSTATE_DTPT_PROCEEED                ( SN_CONNECTIONSDTPTSTATE_USBCABLECONNECTED_BITMASK | \
                                                               SN_CONNECTIONSDTPTSTATE_RASCONNECTED_BITMASK | \
                                                               SN_CONNECTIONSDTPTSTATE_UDP2TCPCONNECTED_BITMASK | \
                                                               SN_CONNECTIONSDTPTSTATE_PROXIESPOPULATED_BITMASK )
#else
// Knocking out proxy requirement for now, since we are in a known no-proxy time
// When proxies come across MTPz, we'll go back to including them.
#define SN_CONNECTIONSDTPTSTATE_DTPT_PROCEEED                ( SN_CONNECTIONSDTPTSTATE_USBCABLECONNECTED_BITMASK | \
                                                               SN_CONNECTIONSDTPTSTATE_RASCONNECTED_BITMASK | \
                                                               SN_CONNECTIONSDTPTSTATE_UDP2TCPCONNECTED_BITMASK )
#endif
// These are the public events to use.
#define SN_CONNECTIONSDTPTSTATE_DTPT_AVAILABLE               ( SN_CONNECTIONSDTPTSTATE_DTPT_PROCEEED )
#define SN_CONNECTIONSDTPTSTATE_DTPT_UNAVAILABLE             (DWORD)0x00000000
#define SN_CONNECTIONSDTPTSTATE_DTPT_POSSIBLE                SN_CONNECTIONSDTPTSTATE_USBCABLECONNECTED_BITMASK
// These values are for measuring realtime of dependent events
#define SN_CONNECTIONSDTPTSTATE_USBCABLECONNECTED_TIME_VALUE       TEXT("UsbCableConnected_MS")
#define SN_CONNECTIONSDTPTSTATE_USBCABLEDISCONNECTED_TIME_VALUE    TEXT("UsbCableDisconnected_MS")
#define SN_CONNECTIONSDTPTSTATE_RASCONNECTED_TIME_VALUE            TEXT("RasConnected_MS")
#define SN_CONNECTIONSDTPTSTATE_RASDISCONNECTED_TIME_VALUE         TEXT("RasDisconnected_MS")
#define SN_CONNECTIONSDTPTSTATE_UDP2TCPCONNECTED_TIME_VALUE        TEXT("Udp2TcpConnected_MS")
#define SN_CONNECTIONSDTPTSTATE_PROXIESPOPULATED_TIME_VALUE        TEXT("ProxiesPopulated_MS")  
