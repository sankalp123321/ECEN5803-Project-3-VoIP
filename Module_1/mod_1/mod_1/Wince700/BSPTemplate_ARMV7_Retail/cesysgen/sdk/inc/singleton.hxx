...
/**/
/**/    // c) You can control singleton lifetime by explicitly calling addref and release methods:
/**/
/**/    void Foo_Init()
/**/    {
/**/        // ...
...
/**/
/**/    // !!NOTE!!
/**/    // If your code may result in a singleton being used from the *dtor* of global object
/**/    // but the singleton is not being accessed from the *ctor* of this object, you will need to
/**/    // explicitly instantiate the singleton's _factory member *before* the global object definition. 
/**/    // E.g.:
/**/
/**/    template<> ce::singleton<MyType>::lock_factory ce::singleton<MyType>::_factory;
/**/
/**/    ///////////////////////////////////////////////////
