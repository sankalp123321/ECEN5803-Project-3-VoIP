...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_IsAuthenticated)(THIS_ Boolean FAR* pisAuthenticated) PURE;
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_IsOpen)(THIS_ Boolean FAR* pisOpen) PURE;
...
DEFINE_GUID(IID_IMSMQPrivateEvent,0xD7AB3341L,0xC9D3,0x11D1,0xBB,0x47,0x00,0x80,0xC7,0xC5,0xA2,0xC0);

/* Definition of interface: IMSMQPrivateEvent */
#undef INTERFACE
#define INTERFACE IMSMQPrivateEvent

DECLARE_INTERFACE_(IMSMQPrivateEvent, IDispatch)
{
BEGIN_INTERFACE
#ifndef NO_BASEINTERFACE_FUNCS
    ...
    STDMETHOD(FireArrivedEvent)(THIS_ IMSMQQueue FAR* pq, long msgcursor) PURE;
    STDMETHOD(FireArrivedErrorEvent)(THIS_ IMSMQQueue FAR* pq, long hrStatus, long msgcursor) PURE;
};
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_IsTransactional)(THIS_ Boolean FAR* pisTransactional) PURE;
    STDMETHOD(get_PrivLevel)(THIS_ long FAR* plPrivLevel) PURE;
    STDMETHOD(put_PrivLevel)(THIS_ long lPrivLevel) PURE;
    STDMETHOD(get_Journal)(THIS_ long FAR* plJournal) PURE;
    STDMETHOD(put_Journal)(THIS_ long lJournal) PURE;
    ...
    STDMETHOD(get_IsWorldReadable)(THIS_ Boolean FAR* pisWorldReadable) PURE;
