...
#define WM_INPUTLANGLISTUPDATE          0x0056
...
#define GID_SCROLL_DIRECTION(x)         ((ULONG)(HIWORD(((ULONGLONG)(x)) >> 32) & 0x000F))
#define GID_SCROLL_VELOCITY(x)          ((LONG)((short)(LOWORD(((ULONGLONG)(x)) >> 32))))

// Macros to extract GID_DIRECTMANIPULATION details
#define GID_DIRECTMANIPULATION_DELTA_X(x)    ((SHORT)(LOWORD((ULONG)((x) & 0xffffffff))))
#define GID_DIRECTMANIPULATION_DELTA_Y(x)    ((SHORT)(HIWORD((ULONG)((x) & 0xffffffff))))

// Macros to get distance between contacts for multitouch pan
#define GID_PAN_CONTACT_SEPARATION(x)   ((LONG)(((ULONGLONG)(x)) >> 32))

#define GID_TO_TGF(x)                   (1ULL << (x))
...
#define TGF_GID_DIRECTMANIPULATION      GID_TO_TGF(GID_DIRECTMANIPULATION)
#define TGF_GID_ALL                     (0xFFFFFFFFFFFFFFFFULL)
...
#define WM_OBSCURED                     0x0335
/*
 * WM_OBSCURED state values
 */
#define WO_UNOBSCURED   0
#define WO_OBSCURED     1
...
MsgWaitForMultipleObjectsEx(
    DWORD nCount,
    __in_ecount_opt(nCount) LPHANDLE pHandles,
...
// Specifies that the touch event came from the user's palm
