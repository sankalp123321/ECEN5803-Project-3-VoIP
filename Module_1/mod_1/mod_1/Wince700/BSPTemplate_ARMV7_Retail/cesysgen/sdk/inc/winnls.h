...
{
    CALID       CalId;      // the calendar id for the date
    UINT        Era;        // era information
    UINT        Year;       // year
    UINT        Month;      // month
    UINT        Day;        // day
    UINT        DayOfWeek;  // day of week
...
GetDateFormatEx(
  ...
  __out  LPWSTR lpDateStr,
  __in   int cchDate,
  __in   LPCWSTR lpCalendar
);
...
GetDurationFormatEx(
  __in   LPCWSTR lpLocaleName,
  __in   DWORD dwFlags,
  __in   const SYSTEMTIME *lpDuration,
  __in   ULONGLONG ullDuration,
  __in   LPCWSTR lpFormat,
  __out  LPWSTR lpDurationStr,
...
GetCalendarInfoEx(
  __in   LPCWSTR lpLocaleName,
  __in   CALID Calendar,
  __in   LPCWSTR lpReserved,
  __in   CALTYPE CalType,
  __out  LPWSTR lpCalData,
  __in   int cchData,
...
GetCalendarDateFormatEx(
  __in   LPCWSTR lpszLocale,
  __in   DWORD dwFlags,
  __in   const LPCALDATETIME lpCalDateTime,
  __in   LPCWSTR lpFormat,
  __out  LPWSTR lpDateStr,
  __in   int cchDate
);
...
UpdateCalendarDayOfWeek(
  __inout  LPCALDATETIME lpCalDateTime
);
...
GetCalendarWeekNumber(
                         const LPCALDATETIME lpCalDateTime,
                         UINT firstDayOfWeek,
                         UINT firstWeekOfYear,
                         __out UINT *calWeekNumber);
...
GetCalendarSupportedDateRange(
                             CALID Calendar, 
                             __out LPCALDATETIME lpCalMinDate, 
                             __out LPCALDATETIME lpCalMaxDate);
