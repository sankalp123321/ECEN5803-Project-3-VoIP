...
enum __MIDL___MIDL_itf_xmlparser_0000_0000_0003
	...
	XML_E_DTD_PROHIBITED	= ( XML_E_MISSINGNAME + 1 ) ,
	XML_E_MAXXMLSIZE	= ( XML_E_DTD_PROHIBITED + 1 ) ,
	XML_E_MAXELEMENTDEPTH	= ( XML_E_MAXXMLSIZE + 1 ) ,
	XML_E_LASTERROR	= ( XML_E_MAXELEMENTDEPTH + 1 ) 
    } 	XML_ERROR_CODE;
