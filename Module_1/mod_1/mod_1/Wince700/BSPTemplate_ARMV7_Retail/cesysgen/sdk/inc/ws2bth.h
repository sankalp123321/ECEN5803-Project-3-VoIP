...
#define SO_BTH_SET_SECURITY_LEVEL   0x0000002c  // no restrictions. optlen=sizeof(BTSecurityLevel), optval = &BTSecurityLevel
#define SO_BTH_GET_SECURITY_LEVEL   0x0000002d  // no restrictions. optlen=sizeof(BTSecurityLevel), optval = &BTSecurityLevel
