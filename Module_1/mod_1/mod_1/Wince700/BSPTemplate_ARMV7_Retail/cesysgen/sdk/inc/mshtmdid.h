...
#define DISPID_IHTMLDOCUMENT6_ISCOMPATIBLE                        DISPID_OMDOCUMENT+104
#define DISPID_IHTMLDOCUMENT6_IE8_GETELEMENTBYID                  DISPID_OMDOCUMENT+150
...
//    DISPIDs for interface IHttpHeaderInfo

#define DISPID_IHTTPHEADERINFO_SETEXTRAHEADERS                    
#define DISPID_IHTTPHEADERINFO_GETACCEPTHEADER                    

//    DISPIDs for interface IMobileUIHandler

#define DISPID_IMOBILEUIHANDLER_ATTACH                            
#define DISPID_IMOBILEUIHANDLER_UPDATE                            
#define DISPID_IMOBILEUIHANDLER_DETACH                            
#define DISPID_IMOBILEUIHANDLER_SETPARENTWINDOW                   

//    DISPIDs for interface IMobileUIHandlerProvider

#define DISPID_IMOBILEUIHANDLERPROVIDER_GETMOBILEUIHANDLER        
