...
#define LMEM_REG_RESOLVE_STACKS L"ResolveStacks"
...
#define LMEM_ALLOC_SIZE_INCREF   0xFFFFFFFC  // Special size for ref count objects
#define LMEM_ALLOC_SIZE_DECREF   0xFFFFFFFB  // Special size for ref count objects
...
VOID WINAPI LMEMDumpTrackedItem (HANDLE hHeap, LPVOID pAllocMem);
typedef VOID (WINAPI *PFN_LMEMDumpTrackedItem) (HANDLE hHeap, LPVOID pAllocMem);
