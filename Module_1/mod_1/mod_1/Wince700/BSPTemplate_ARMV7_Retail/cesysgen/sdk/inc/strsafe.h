    ...
    __in STRSAFE_LPCSTR pszSrc)
{
   ...
   if (SUCCEEDED(hr))
   {
       // StringLengthWorkerA() would fail if cchDest is
       // smaller than the real length of pszDest
       //
       __analysis_assume(cchDest >= cchDestLength);
    ...
    __in STRSAFE_LPCWSTR pszSrc)
{
   ...
   if (SUCCEEDED(hr))
   {
       // StringLengthWorkerW() would fail if cchDest is
       // smaller than the real length of pszDest
       //
       __analysis_assume(cchDest >= cchDestLength);
