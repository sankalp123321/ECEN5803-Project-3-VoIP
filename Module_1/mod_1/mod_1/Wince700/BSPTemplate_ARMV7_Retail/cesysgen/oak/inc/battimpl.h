...
BOOL WINAPI BatteryAPIGetSystemPowerStatusEx(PSYSTEM_POWER_STATUS_EX pstatus,
                       BOOL fUpdate);
BOOL WINAPI BatteryAPIGetLifeTimeInfo (LPSYSTEMTIME pstLastChange, DWORD * pcmsCpuUsage,
                       DWORD * pcmsPreviousCpuUsage);
BOOL WINAPI BatteryAPINotifyOfTimeChange (BOOL fForward, FILETIME * pftDelta);
