...
#define FATUTIL_FULL_FORMAT           0x01   // perform a full format
#define FATUTIL_FORMAT_TFAT           0x02   // format volume as TFAT
#define FATUTIL_DISABLE_MOUNT_CHK     0x04   // disable checking to see if volume is mounted before doing operation
#define FATUTIL_SECURE_WIPE           0x08   // secure wipe, which is full format that will continue through power loss
#define FATUTIL_FORMAT_EXFAT          0x10   // format volume as exFAT
#define FATUTIL_SCAN_VERIFY_FIX       0x01   // prompt user to perform a fix

// Signiture to mark secure wipe in progress
#define SECURE_WIPE_BOOT_SIG 0xa1b2c3d4
