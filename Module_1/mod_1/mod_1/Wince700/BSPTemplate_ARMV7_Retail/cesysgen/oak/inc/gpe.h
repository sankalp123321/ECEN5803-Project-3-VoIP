...
public:
    ...
    GPESurf()
    {   
        // Null constructor; call Init() to initialize
        m_pVirtAddr   = NULL;
        m_fOwnsBuffer = 0;
    }   
...
#define GPE_BACK_BUFFER              0x00000004
