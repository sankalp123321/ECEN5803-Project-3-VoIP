...
// Toolbar custom draw return values
#define TBCDRF_WHITEDROPDOWNARROW   0x01000000
...
#define CDRF_VALIDFLAGS         0xFFFF01FE   //
...
#define MCM_STORYBOARDCOMPLETED          (WM_USER + 1)  // private message to get back to the MonthCal main thread after a storyboard has finished
#define MCS_VALIDBITS       0x009F          //
#define MCS_INVALIDBITS     ((~MCS_VALIDBITS) & 0x0000FFFF) //
#define DTS_FORMATMASK      0x000C
#define DTS_VALIDBITS       0x03FF //
