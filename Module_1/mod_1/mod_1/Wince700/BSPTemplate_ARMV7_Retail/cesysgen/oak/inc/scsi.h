...
typedef union _CDB {
    ...
    //
    // SCSI-3 Inquiry CDB - Updated for revision 23
    //
    struct _CDB6INQUIRY3_23 {
        UCHAR OperationCode;    // 0x12 - SCSIOP_INQUIRY
        UCHAR EnableVitalProductData : 1;
        UCHAR Obsolete : 1;
        UCHAR Reserved1 : 6;
...
// Fourth Revision Adds
// * LJRS
// * NextlayerJump
// * LastLayerJump
// Total structure size increased by 8 bytes
typedef struct _TRACK_INFORMATION4 {
    ...
    UCHAR Reserved7[2];
    UCHAR ReadCompatibilityLba[4];
    UCHAR NextLayerJump[4];
    UCHAR LastLayerJump[4];

} TRACK_INFORMATION4, *PTRACK_INFORMATION4;
...
#pragma pack(push, mech_status, 1)
typedef struct _MECHANISM_STATUS_HEADER {

    UCHAR CurrentSlotLow       : 5; // Low 5 bits
    UCHAR ChangerState         : 2;
    UCHAR Fault                : 1;

    UCHAR CurrentSlotHigh      : 3; // High 3 bits
    UCHAR Reserved1            : 1;
    UCHAR DoorOpen             : 1;
    UCHAR MechanismState       : 3;

    UCHAR CurrentLBA[3];
    UCHAR NumberOfSlotsAvailable;
    UCHAR LengthOfSlotTables[2];
} MECHANISM_STATUS_HEADER, *PMECHANISM_STATUS_HEADER;
#pragma pack(pop, mech_status)
...
#define SCISOP_WRITE_VERIFY16           0x8E
...
//
// Define power condition parameters page
//
#pragma pack(push, mode_page_pcp, 1)
typedef struct
{
    UCHAR PageCode : 6;             // MODE_POWER_PAGE_CONDITION (0x1A)
    UCHAR Reserved : 1;
    UCHAR PS : 1;
    UCHAR PageLength;
    UCHAR Reserved2;
    ...
    UCHAR Idle : 1;
    UCHAR Reserved3 : 6;
    UCHAR IdleConditionTimer[4];
    UCHAR StandyConditionTimer[4];
} MODE_POWER_CONDITION, *PMODE_POWER_CONDITION;
#pragma pack(pop, mode_page_pcp)
