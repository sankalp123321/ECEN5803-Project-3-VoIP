...
typedef
    enum _THREAD_FIELD_IDS
    {
         ...
         tfiHandleCurrentProcessRunIn   = (3L), // Current process running in.  6.00+ this is the VM Proc.
         ...
         tfiHandleActiveProcess         = (25L), // Handle to the active process of the thread.
         tfiStartAddr                   = (26L), //Start address of thread
...
typedef enum _MODULEPROC_FIELD_IDS
{
    mpfiProcessID = 0,
    mpfiModuleID,
    mpfiRefCount,
    mpfiUserDefined = (-1)
} MODULEPROC_FIELD_IDS;
