...
// For CE, device names are of format "NAT0:"
#define IP_NAT_DEV_PREFIX     TEXT("NAT")
#define IP_NAT_DEV_INDEX      0
#define IP_NAT_DEVICE_NAME    TEXT("NAT0:")
...
#define IOCTL_IP_NAT_ENABLEDISABLE \
    _IP_NAT_CTL_CODE(29, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IP_NAT_INTERFACE_FLAGS_DISABLE_FTP  0x00000008
