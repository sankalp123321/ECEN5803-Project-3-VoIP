...
#define SNMP_GENERICTRAP_V2TRAPESCAPE           7
...
#define SnmpSvcReportEvent(a, b, c, d) 
#define SNMPDBG(a)
#endif
...
#define SNMP_RESET_EVENT_NAME   TEXT("SNMPServiceResetEvent")
#define SNMP_RESET_COMPLETE_EVENT_NAME TEXT("SNMPServiceResetCompleteEvent")
